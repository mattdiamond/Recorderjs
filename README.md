...
- **encoderComplexity** - (*optional*) Value between 0 and 10 which determines the encoder's computational complexity. `0` is fastest with lowest complexity. `10` is slowest with highest complexity. Defaults to `9`.
