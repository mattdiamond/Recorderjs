...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'encoderWorker.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'encoderWorker.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'encoderWorker.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "encoderWorker.js.mem" : null;
